...
$(document).ready(function () {
    ...
    $(document).on('click', '.js-select-all-career-sectors', function(e) {
        $("#edit_request_form_primaryIndustries > option").prop("selected", "selected");
        $("#edit_request_form_primaryIndustries").trigger("change");
    });

    $('#edit_request_form_volunteerRoles').select2({
    ...
    $('#edit_request_form_primaryIndustries').select2({
    ...
    VCountdown({
        target: '#edit_request_form_summary',
        maxChars: 70
    });

    VCountdown({
        target: '#edit_request_form_description',
        maxChars: 280
    });
});