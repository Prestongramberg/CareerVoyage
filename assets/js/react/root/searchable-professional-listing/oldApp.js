...
import { loadProfessionals, radiusChanged, updateCompanyQuery, updatePrimaryIndustryQuery, updateRoleQuery, updateSearchQuery, updateSecondaryIndustryQuery, zipcodeChanged, query } from './actions/actionCreators'
...
class OldApp extends React.Component {
    ...
    updateCompanyQuery(event) {
        debugger;
        this.props.updateCompanyQuery(event);
        this.props.query();
    }
