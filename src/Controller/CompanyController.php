...
class CompanyController extends AbstractController
{
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function addCompanyExperienceIndustry(Request $request, CompanyExperience $companyExperience) {

        $this->denyAccessUnlessGranted('edit', $companyExperience->getCompany());
        ...
        if($secondaryIndustry) {
            $companyExperience->addSecondaryIndustry($secondaryIndustry);
            $this->entityManager->persist($companyExperience);
            $this->entityManager->flush();

            return new JsonResponse(
                [
                    'success' => true,
                    'experience_id' => $companyExperience->getId(),
                    'industry_id' => $secondaryIndustry->getId()
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function removeCompanyExperienceIndustry(Request $request, CompanyExperience $companyExperience) {
        ...
        $companyExperience->removeSecondaryIndustry($secondaryIndustry);
        $this->entityManager->persist($companyExperience);
        $this->entityManager->flush();
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function getCompanyExperienceIndustries(Request $request, CompanyExperience $companyExperience) {

        $secondaryIndustries = $companyExperience->getSecondaryIndustries();
