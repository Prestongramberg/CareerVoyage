...
class FeedbackController extends AbstractController
{
    ...
    public function feedbackViewAction(Request $request, Feedback $feedback)
    {
        ...
        switch ($feedback->getClassName()) {
            case 'EducatorReviewCompanyExperienceFeedback':
                /** @var EducatorReviewCompanyExperienceFeedback $feedback */ /** @var CompanyExperience $experience */ $formType = EducatorReviewCompanyExperienceFeedbackFormType::class;
                $template                                                                                                         = 'view_educator_review_company_experience_feedback.html.twig';
                break;
            case 'EducatorReviewTeachLessonExperienceFeedback':
                /** @var EducatorReviewTeachLessonExperienceFeedback $feedback */ /** @var TeachLessonExperience $experience */ $formType = EducatorReviewTeachLessonExperienceFeedbackFormType::class;
                $template                                                                                                                 = 'view_educator_review_teach_lesson_experience_feedback.html.twig';
                break;
            case 'StudentReviewCompanyExperienceFeedback':
                /** @var StudentReviewCompanyExperienceFeedback $feedback */ /** @var CompanyExperience $experience */ $formType = StudentReviewCompanyExperienceFeedbackFormType::class;
                $template                                                                                                        = 'view_student_review_company_experience_feedback.html.twig';
                break;
            case 'StudentReviewTeachLessonExperienceFeedback':
                /** @var StudentReviewTeachLessonExperienceFeedback $feedback */ /** @var TeachLessonExperience $experience */ $formType = StudentReviewTeachLessonExperienceFeedbackFormType::class;
                $template                                                                                                                = 'view_student_review_teach_lesson_experience_feedback.html.twig';
                break;
            case 'ProfessionalReviewStudentToMeetProfessionalFeedback':
                /** @var ProfessionalReviewStudentToMeetProfessionalFeedback $feedback */ /** @var StudentToMeetProfessionalExperience $experience */ $formType = ProfessionalReviewStudentToMeetProfessionalFeedbackFormType::class;
