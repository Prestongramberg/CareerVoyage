...
class UploadProvider
{
    ...
    public function upload($folder, $imageCategory)
    {
        $faker = \Faker\Factory::create();
        $path = $faker->image(sys_get_temp_dir(), '640', '480', $imageCategory);
    ...
    public function companyPhotoObject($folder, $imageCategory, $width = '640', $height = '480') {
