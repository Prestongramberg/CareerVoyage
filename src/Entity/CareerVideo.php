...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CareerVideoRepository")
 */
class CareerVideo extends Video
{
    /**
     * @Groups({"VIDEO"})
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\SecondaryIndustry", inversedBy="careerVideos")
     */
