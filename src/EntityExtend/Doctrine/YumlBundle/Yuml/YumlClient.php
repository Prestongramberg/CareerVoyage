...
namespace App\EntityExtend\Doctrine\YumlBundle\Yuml;
...
use App\EntityExtend\Doctrine\ORMMetadataGrapher\YUMLMetadataGrapher as MetadataGrapher;
 ...
 *
 * @package App\EntityExtend\Doctrine\YumlBundle\Yuml
 */
class YumlClient implements YumlClientInterface
{
    ...
    public function __construct(
        ...
        $this->metadataGrapher = $metadataGrapher ? $metadataGrapher : new MetadataGrapher($this->entityManager);
    }
    ...
    private function getClasses()
    {
        ...
        foreach ($this->getMetadata() as $class) {
            ...
            if(strpos($class->getName(), 'Extend') === false) {
                continue;
            }
