...
use App\EntityExtend\PhpUtils\ClassLoader;
...
class ExtendClassLoadingUtils
{
    ...
    {
        return $cacheDir . DIRECTORY_SEPARATOR . 'p3_entities' . DIRECTORY_SEPARATOR. 'Extend';
    }
    ...
    public static function registerClassLoader($cacheDir)
    {
        $loader = new ClassLoader(
            ...
            $cacheDir . DIRECTORY_SEPARATOR . 'p3_entities'
        );
        $loader->register();
    }
