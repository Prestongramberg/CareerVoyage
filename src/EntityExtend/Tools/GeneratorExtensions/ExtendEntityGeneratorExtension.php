...
namespace App\EntityExtend\Tools\GeneratorExtensions;

use App\EntityExtend\Config\ExtendScope;
use App\EntityExtend\Config\Id\FieldConfigId;
use App\EntityExtend\Entity\ExtendEntityInterface;
...
class ExtendEntityGeneratorExtension extends AbstractEntityGeneratorExtension
{
    ...
    public function generate(array $schema, PhpClass $class)
    {
        ...
        $class->addInterfaceName(ExtendEntityInterface::class);
