...
/**
 * Class LocalCompanyVideoFilterType
 *
 * @package App\Form\Filter
 */
class LocalCompanyVideoFilterType extends AbstractType
{
    /**
     * @var RequestStack
     */
        ...
        $builder->add(
            'keywordOrProfession', Filters\TextFilterType::class, [
                                     'apply_filter' => function (QueryInterface $filterQuery, $field, $values) {
                                         ...
                                         $queryBuilder->andWhere('cv.name LIKE :searchTerm OR cv.tags LIKE :searchTerm OR pi.name LIKE :searchTerm OR si.name LIKE :searchTerm')
        ...
        $builder->add(
            'primaryIndustry', Filters\EntityFilterType::class, [
                                 ...
                                 'apply_filter'  => function (QueryInterface $filterQuery, $field, $values) {
                                     ...
                                     $queryBuilder->andWhere('c.primaryIndustry = :primaryIndustry')
            ...
            'secondaryIndustries', Filters\EntityFilterType::class, [
                                     ...
                                     'apply_filter'  => function (QueryInterface $filterQuery, $field, $values) {
                                         ...
                                         $queryBuilder->andWhere('si.id = :secondaryIndustry')
                                                      ->setParameter('secondaryIndustry', $secondaryIndustry->getId());
