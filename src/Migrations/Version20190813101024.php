 ...
 */
final class Version20190813101024 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE single_chat (id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_858F94E4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE single_chat ADD CONSTRAINT FK_858F94E4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE chat ADD discr VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat DROP discr');
    }
}
