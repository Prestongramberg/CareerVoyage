...
class LinkedToClassroomWork extends AbstractDashboard
{
    protected $type = 'pie';
    ...
    public function __construct(Traversable $feedbackCollection)
    {
        ...
        foreach ($feedbackCollection as $feedback) {
            ...
            if($feedback['relatedToMyClassroomWork'] === null) {
                continue;
            }

            if($feedback['relatedToMyClassroomWork']) {
                $positive++;
            } else {
                $negative++;
            }
        ...
        $this->header = 'of respondents found the lesson linked to classroom work.';
