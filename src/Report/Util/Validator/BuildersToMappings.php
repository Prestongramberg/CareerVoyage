...
namespace App\Report\Util\Validator;

use Symfony\Component\PropertyInfo\Extractor\ReflectionExtractor;
use Symfony\Component\PropertyInfo\PropertyInfoExtractor;

/**
 * Class BuildersToMappings
 * @package App\Report\Util\Validator
 */
            ...
            foreach ($classesAndMappings as $classAndMapping) {
                ...
                if ($builderClass === $mappingClass) {
                    ...
                    foreach ($config['filters'] as $filter) {
                        if (!array_key_exists($filter['id'], $mappingProperties) && !preg_match('/JSON_ATTR\((.+),(.+)\)/', $filter['id'])) {
