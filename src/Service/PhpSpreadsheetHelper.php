    ...
    public function getColumns(File $uploadedFile) {
        ...
        switch ($fileExtension) {
            ...
            case 'csv':
                ...
                break;
            default:
                throw new \Exception(sprintf("Error reading file. Make sure file is a valid CSV, ODD, or XLSX. File extension %s being used.", $fileExtension));
                break;
        }
    ...
    public function getReader(File $uploadedFile) {
        ...
        switch ($fileExtension) {
            ...
            case 'csv':
                ...
                break;
            default:
                throw new \Exception(sprintf("Reader could not be created from file extension: %s", $fileExtension));
                break;
        }
