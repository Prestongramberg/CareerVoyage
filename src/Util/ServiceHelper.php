...
trait ServiceHelper
{
    ...
    public function __construct(
        ...
        $this->educatorRegisterStudentForExperienceRequestRepository
                                             = $educatorRegisterStudentForExperienceRequestRepository;
        $this->educatorRegisterEducatorForCompanyExperienceRequestRepository
                                             = $educatorRegisterEducatorForCompanyExperienceRequestRepository;
        $this->schoolAdminRegisterSAForCompanyExperienceRequestRepository
                                             = $schoolAdminRegisterSAForCompanyExperienceRequestRepository;
        $this->schoolRepository
                                             = $schoolRepository;
        $this->teachLessonExperienceRepository
                                             = $teachLessonExperienceRepository;
        $this->companyFavoriteRepository
                                             = $companyFavoriteRepository;
        $this->registrationRepository
                                             = $registrationRepository;
        $this->educatorReviewCompanyExperienceFeedbackRepository
                                             = $educatorReviewCompanyExperienceFeedbackRepository;
        $this->educatorReviewTeachLessonExperienceFeedbackRepository
                                             = $educatorReviewTeachLessonExperienceFeedbackRepository;
        $this->studentReviewCompanyExperienceFeedbackRepository
                                             = $studentReviewCompanyExperienceFeedbackRepository;
        $this->studentReviewTeachLessonExperienceFeedbackRepository
                                             = $studentReviewTeachLessonExperienceFeedbackRepository;
        ...
        $this->geocoder
                                             = $geocoder;
        $this->rolesWillingToFulfillRepository
                                             = $rolesWillingToFulfillRepository;
        $this->allowedCommunicationsRepository
                                             = $allowedCommunicationsRepository;
        $this->userRegisterForSchoolExperienceRequestRepository
                                             = $userRegisterForSchoolExperienceRequestRepository;
        $this->phpSpreadsheetHelper
                                             = $phpSpreadsheetHelper;
        $this->companyVideoRepository
                                             = $companyVideoRepository;
        $this->careerVideoRepository
                                             = $careerVideoRepository;
        $this->videoFavoriteRepository
                                             = $videoFavoriteRepository;
        $this->videoRepository
                                             = $videoRepository;
        $this->professionalVideoRepository
                                             = $professionalVideoRepository;
        $this->helpVideoRepository
                                             = $helpVideoRepository;
        $this->chatHelper
                                             = $chatHelper;
        $this->globalShare
        ...
        $this->reportRepository
                                             = $reportRepository;
        $this->reportColumnRepository
                                             = $reportColumnRepository;
        $this->countyRepository
                                             = $countyRepository;
        $this->reportService
                                             = $reportService;
        $this->reportGroupRepository
                                             = $reportGroupRepository;
        $this->userMetaRepository
                                             = $userMetaRepository;
        $this->requestActionRepository
                                             = $requestActionRepository;
        $this->resourceRepository
                                             = $resourceRepository;
        $this->knowledgeResourceRepository
